...
# Who Am I? (Definitely Not Iron Man ...)

.pull-left[
* __Head of the Biostatistics Team__ of the  __Inserm U1283 / CNRS UMR 8199__ _(Functional (Epi)genomics and Molecular Physiology of Diabetes and Related Diseases)_.  
    <img src="https://raw.githubusercontent.com/mcanouil/hex-stickers/master/SVG/umr1283_8199.svg", width="100px" class="center" />

* __Doctor of Philosophy (Ph.D.) in Biostatistics__.

* Authored __4 <i class="fab fa-r-project"></i> packages__ on CRAN (more on Github).  
    <img src="https://raw.githubusercontent.com/mcanouil/hex-stickers/master/SVG/nacho.svg" width="100px" /><img src="https://raw.githubusercontent.com/mcanouil/hex-stickers/master/SVG/insane.svg" width="100px" /><img src="https://github.com/mcanouil/ggpacman/raw/master/man/figures/ggpacman.gif" width="100px" />

* Contributed to __2 <i class="fab fa-r-project"></i> packages__ on CRAN.

* .font70[_Watched 2,850 movies so far ..._]
]

.pull-right[
.center[
<img src="https://github.com/mcanouil/ggpacman/raw/master/man/figures/README-pacman-1.gif" height="500px" />  
_From_ `ggpacman` _on CRAN. This is only a GIF️, sorry!_
]
]
