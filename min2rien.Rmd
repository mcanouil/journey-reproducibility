...
params:
  ...
  date: 'Wednesday, the 14<sup><i style="font-size:0.5em;">th</i></sup> of April, 2021 – 11 h 00 (UTC + 1)'
...
```{css, echo = FALSE}
:root {
  --logo: url(https://raw.githubusercontent.com/mcanouil/hex-stickers/master/SVG/mc.svg);
}
```
...
.slide-url[
[m.canouil.fr/journey-reproducibility/min2rien.html](https://m.canouil.fr/journey-reproducibility/min2rien.html)
]
